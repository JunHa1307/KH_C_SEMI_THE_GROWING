...
<link rel="shortcut icon" type="image/svg" href="<%= contextPath %>/favicon.svg"/>
			...
			<div class="timeTable">
				...
				<div class="table-btn">
					<button type="button" class="button_UI button--winona"
						data-text="업데이트" onclick="tableUpdate();"><span>업데이트</span></button>
					<button type="button" class="button_UI button--winona"
						data-text="행 추가" onclick="insertRow();"><span>행 추가</span></button>
				</div>
			</div>
			<!-- 캘린더 -->
			<div id='calendar-container' class="schedule">
				...
				<div class="table-btn">
					<button id="calendar-button" type="button" class="button_UI button--winona"
							data-text="업데이트"><span>업데이트</span></button>
				</div>
			</div>
		</section>
